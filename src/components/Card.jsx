...
const Card = ({ key, kategori, image, nama, price, kondisi, closeOrder, buka ,type}) => {
  return (
    <div key={key} className={`w-40 lg:w-full ${type==="jastip"?"h-[19.063rem] ":"h-72 l"} lg:h-[22.5rem]    p-3 border font-Poppins  hover:bg-Primary-White duration-300 hover:shadow-2xl hover:-translate-y-1 ease-in-out flex flex-col justify-between border-Outline-gray rounded-2xl`}>
