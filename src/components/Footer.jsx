  ...
  return (
    <footer className="w-full py-9 flex gap-9 flex-col justify-center font-Poppins  bg-Primary-Blue ">
      <div className="flex flex-col gap-4 items-center">
        ...
        <button className="px-4 py-2 btn text-base hover:bg-Secondary-LightTeal duration-300 ease-in-out active:bg-Secondary-LightTeal bg-Primary-White text-Primary-Blue">Hubungi customer service</button>
      </div>
      <div className="flex flex-col gap-4 items-center">
