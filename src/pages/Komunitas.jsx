    ...
    <div className="bg-Primary-LightBlue font-Poppins">
      <main className="w-full p-4 md:px-24 md:gap-8 flex md:flex-row-reverse flex-col ">
        ...
        <div className="w-full">
          <div className="md:flex hidden md:w-4/5 ms-auto items-center justify-between mb-4 ">
            <h2 className="text-lg font-semibold bg-Secondary-LightYellow text-Text-Black bg-opacity-50 py-1 px-3 rounded-2xl">😲 Komunitas BRAW! </h2>
            <DropdownCheckbox option={kategori} onSelect={handleCategorySelect} />
                    ...
                    <Link key={index} to={`/komunitas/${item.idKomunitasbraw}`}>
                      <div className="w-full md:w-4/5  ms-auto border md:h-40 h-36 flex gap-2 border-Outline-gray rounded-2xl p-3 hover:bg-Primary-White duration-300 hover:shadow-2xl hover:-translate-y-1 ease-in-out">
                        ...
                        <div className="size-full flex  flex-col justify-between ">
                          ...
                          <p className="text-Text-Black text-xs  font-medium line-clamp-1 md:line-clamp-3">{item.description}</p>
